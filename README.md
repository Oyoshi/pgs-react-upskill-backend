...
In case if you got errors `No metadata for <Entity> was found` just stop containers by typing: `docker-compose down` and restart them with `docker-compose up -d`.
